<%@ Page Title="" Language="C#" MasterPageFile="~/_Masters/AdminMasterPage.master" Async="true" AutoEventWireup="true" CodeFile="DownloadContracts.aspx.cs" Inherits="Admin_DownloadContractsPage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="about">
        <h2>Download Contracts</h2>
         <div>
        ...
        <p>
            Click <asp:LinkButton ID="btnDownload" Text="here" runat="server" OnClick="btnDownload_Click" /> to download all contracts to a CSV file.
        </p>
