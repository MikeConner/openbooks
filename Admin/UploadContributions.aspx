<%@ Page Title="" Language="C#" MasterPageFile="~/_Masters/AdminMasterPage.master" AutoEventWireup="true" CodeFile="UploadContributions.aspx.cs" Inherits="Admin_UploadContributionsPage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="about">
        <h2>Upload Campaign Contributions</h2>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    <asp:BulletedList ID="ddlContributionType" runat="server"
