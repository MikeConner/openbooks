...
public partial class Admin_UploadExpendituresPage : System.Web.UI.Page
{
    ...
    protected void UploadButton_Click(object sender, EventArgs e)
    {
        ...
        if (FileUpload1.HasFile)
        {
            ...
            UploadErrors.Visible = false;
            List<string> errors = Admin.UploadExpenditures(fullPath, User.Identity.Name, int.Parse(ddlCandidateName.SelectedValue), ddlOffice.SelectedValue);
