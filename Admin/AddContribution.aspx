...
<h2>Add Campaign Contributions</h2>
	...
	<table cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td><asp:RadioButtonList ID="rblContributor" runat="server" RepeatDirection="Horizontal">
		...
		<tr>
			...
			<td><asp:TextBox ID="txtContributor" runat="server" Width="250" />
		...
		<tr>
			...
			<td><asp:TextBox ID="txtEmployer" runat="server" Width="250" /></td>
		</tr>
		<tr>
			<td><label>Occupation</label></td>
			<td><asp:TextBox ID="txtOccupation" runat="server" Width="250" /></td>
		</tr>
		<tr>
