    ...
    <div class="search-page">
        ...
        <div class="row search-row">
            ...
            <div class="medium-4 large-3 columns">
                <h3>Instructions</h3>
                <div class="items-container">
                <p>Search here for campaign contributions. You can filter by candidate, office, or date. You can also search using specific contributors or employers. Finally, you can limit the search to a geographic area centered on a zipcode.</p>
                <p>Since the number of results might be quite large, contributions are presented one page at a time. You can set the page size from 10-100, and also sort by most of these criteria. (Click on the arrow to the right to change the sort direction.)</p>
                </div>
            </div>         
        </div>
    </div>
