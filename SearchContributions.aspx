<%@ Page Title="" Language="C#" MasterPageFile="~/_Masters/MasterPage.master" AutoEventWireup="true" CodeFile="SearchContributions.aspx.cs" Inherits="SearchContributionsPage" %>
    ...
    <div class="search-page">
        ...
        <div class="row search-row">
            <div class="medium-4 large-3 columns">
                ...
                <div class="search-field">
                    <asp:Button ID="Button1" runat="server" Text="Search" OnClick="btnSearch_Click" CssClass="submit button" />
                </div>
            </div>
            <div class="medium-8 large-9 columns">
                ...
                <div id ="instructions">
                    ...
                    <div class="items-container instructions-content">
                         ...
                         <h4>Searching</h4>
                     <p>Search here for campaign contributions.</p>
                        <h4>Search Criteria</h4>
                        <p>
                            You can filter by candidate, office, or date. You can also search using specific contributors or employers.</p>
                        <p>Finally, you can limit the search to a geographic area centered on a zipcode.</p>
                        

                        <h4>Search Results</h4>

                        <p>Since the number of results might be quite large, contributions are presented one page at a time. You can set the page size from 10-100.</p>
