...
<div class="mainwrap">
	<div class="gridboxhead"><h2>Campaign Expenditures Search Results</h2></div>
	<div class="results">
	...
	<table class="ob-gridview" cellpadding="0" cellspacing="0">
		<tr>
			<th><asp:LinkButton ID="LinkButton1" Text="Company/Individual" OnClick="sortCompany" runat="server" /><asp:Image ID="imgSortCompany" runat="server" /></th>
