        ...
        <div class="row">
            <div class="large-12 columns">
                <div class="inforightcontent">
                    ...
                    <h4>Searching By County Contracts</h4>
                    <ul>
                        <li>Select the desired County Department from the drop down box. This box will display a list of Departments. You can select only one.</li>
