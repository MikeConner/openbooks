...
/****** Object:  StoredProcedure [dbo].[SearchExpendituresSQL]    Script Date: 10/21/2014 12:27:04 PM ******/
SET ANSI_NULLS ON
GO
...
(
	...
	(
		SELECT e.ExpenditureID, e.CandidateID, e.Office, e.CompanyName, 
			e.Address1, e.City, e.State, e.Zip, e.Description, e.Amount, e.DatePaid, e.DateEntered, e.Approved,
			tc.CandidateName 
		FROM expenditures e 
