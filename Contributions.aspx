...
<div class="mainwrap">
	<div class="gridboxhead"><h2>Campaign Contributions Search Results</h2></div>
	<div class="results">
	...
	<table class="ob-gridview" cellpadding="0" cellspacing="0">
		<tr>
			<th><asp:LinkButton ID="LinkButton1" Text="Contributor" OnClick="sortContributor" runat="server" /><asp:Image ID="imgSortContributor" runat="server" /></th>
			<th><asp:LinkButton ID="LinkButton2" Text="Candidate" OnClick="sortCandidate" runat="server" /><asp:Image ID="imgSortCandidate" runat="server" /></th>
			<th><asp:LinkButton ID="LinkButton3" Text="Office Sought" OnClick="sortOffice" runat="server" /><asp:Image ID="imgSortOffice" runat="server" /></th>
			<th><asp:LinkButton ID="LinkButton4" Text="Employer" OnClick="sortEmployer" runat="server" /><asp:Image ID="imgSortEmployer" runat="server" /></th>
			<th>Occupation</th>
			<th>Address</th>
			<th><asp:LinkButton ID="LinkButton8" Text="Amount" OnClick="sortAmount" runat="server" /><asp:Image ID="imgSortAmount" runat="server" /></th>
			<th><asp:LinkButton ID="LinkButton9" Text="Date" OnClick="sortDate" runat="server" /><asp:Image ID="imgSortDate" runat="server" /></th>
			<th>Description</th>
			<th>Distance</th>
		</tr>
		...
		<tr class='<%# Container.ItemIndex % 2 == 0 ? "" : "even" %>' valign="top">
			...
			<td>
				<asp:panel id="pnlDistance" runat="server" visible='<%# DataBinder.Eval(Container.DataItem, "distance") != DBNull.Value %>'>
					<asp:label id="lblDistance" runat="server" text='<%# DataBinder.Eval(Container.DataItem, "distance") %>' /> miles
				</asp:panel>
			</td>
		</tr>
	</ItemTemplate>
